...
# ── Engine ─────────────────────────────────────────────────────────────────────
MAX_ITERATIONS     = int(os.getenv("MAX_ITERATIONS", "4"))      # Reducido: menos loops = menos tokens
MAX_TASKS_PER_PLAN = int(os.getenv("MAX_TASKS_PER_PLAN", "5"))  # Planes más concretos

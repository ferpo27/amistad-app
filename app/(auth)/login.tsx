  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={styles.inner}>
        ...
        <TouchableOpacity onPress={() => router.push('/(auth)/register' as any)} style={styles.linkContainer}>
...
const styles = StyleSheet.create({
  ...
  input: { height: 52, borderColor: '#ddd', borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 16, marginBottom: 6, fontSize: 16, backgroundColor: '#fafafa' },
  inputError: { borderColor: '#ff4d4f' },
  errorText: { color: '#ff4d4f', fontSize: 12, marginBottom: 8, marginLeft: 4 },
  button: { height: 52, backgroundColor: '#4C8EFF', borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginTop: 16 },
